...
Transfinite Curve {5, -7} = 110 Using Progression 1.05;   // 90
Transfinite Curve {-1, 3} = 50 Using Progression 1.1;   // 30
Transfinite Curve {2, -4, 6} = 60 Using Progression 1.08;  // 110
